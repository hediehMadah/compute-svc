...
def compute():
    ...
    if n < 0:
        ...
        return jsonify(result=result, latency=latency), 200  # Changed to return result for non-negative inputs.
...
def metrics_endpoint():  # Renamed to avoid conflict with metrics object
    return 'metrics', 200
